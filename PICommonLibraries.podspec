...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PICommonLibraries.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/pavan/PICommonLibraries'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'pavan' => 'itagi75@gmail.com' }
  s.source           = { :git => 'https://github.com/pavan/PICommonLibraries.git', :tag => s.version.to_s }
